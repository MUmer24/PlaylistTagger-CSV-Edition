...
**Success Summary (`summary_log.txt`):**
![Success Summary](assets/imgs/processing_summary.png)

**Failed Songs Log (`failed_log.txt`):**
![Failed Songs Log](assets/imgs/failed_log.png)
...
![CSV Validation & Column Mapping](assets/imgs/csv_validation.png)
...
**Interactive Progress Bar during download:**
![Download Progress](assets/imgs/download_progress.png)
...
**Project structure shown in the IDE explorer:**
![Project Structure in Explorer](assets/imgs/ide_explorer.png)
